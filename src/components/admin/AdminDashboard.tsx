          ...
          {navItems.map(item => {
            ...
            return (
              <Link
                key={item.href}
                href={item.href}
                className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-slate-400 hover:text-white hover:bg-white hover:bg-opacity-10 transition-colors"
              >
      ...
      <div className="flex-1 md:ml-64">
        ...
        <header className="bg-white border-b border-slate-100 px-6 py-4 flex items-center justify-between sticky top-0 z-10">
          <div>
            ...
            <p className="text-muted text-sm">Lundi 23 juin 2024</p>
          </div>
          <div className="flex items-center gap-3">
